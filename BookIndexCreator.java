...
/**
 * Class to create an index based on a file input.
 * 
 * @author Anish
 *
 */
public final class BookIndexCreator {
    /**
    ...
    /**
     * Empty constructor for BookIndexCreator.
     */
    ...
    public static void main(String[] args) throws IOException {
        ...
        /*for(String s: inO2){
            System.out.println("{" + s + ", " + b.getValueFromKey(s) + "}");
        }*/
     ...
     */
    public static void writeFile(File file, MyBST<String, String> b) 
        throws IOException {
        java.util.List<String> inO2 = b.inOrder();
        BufferedWriter bw = new BufferedWriter(new 
                FileWriter(file.getName() + ".index"));
